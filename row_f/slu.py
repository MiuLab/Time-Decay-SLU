...
parser.add_argument('--attention', default='universal', choices=['universal', 'convex', 'linear', 'concave'])
        ...
        for cnt in range(50):
            ...
            _, intent_output, loss = sess.run([model.train_op, model.intent_output, model.loss],
                    feed_dict={
                        ...
                        model.history_distance:history_distance,
                        })
        ...
        for i in range(0, len(batch_nl), batch_size):
            temp_test_output = sess.run([model.intent_output],
                feed_dict={
                    ...
                    model.history_distance:history_distance[i:i+batch_size],
                    })
